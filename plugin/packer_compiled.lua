...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "nvim-autopairs", "LuaSnip", "cmp-cmdline", "cmp-buffer", "cmp-path" },
  ...
  ["nvim-web-devicons"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/xujian/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["project.nvim"] = {
    loaded = true,
    path = "/home/xujian/.local/share/nvim/site/pack/packer/start/project.nvim",
  ...
  ["telescope-vim-bookmarks.nvim"] = {
    loaded = true,
    path = "/home/xujian/.local/share/nvim/site/pack/packer/start/telescope-vim-bookmarks.nvim",
  ...
  ["vim-bookmarks"] = {
    commands = { "BookmarkShowAll", "BookmarkClear", "BookmarkMoveToLine", "BookmarkAnnotate", "BookmarkToggle", "BookmarkNext", "BookmarkPrev", "BookmarkClearAll", "BookmarkMoveDown", "BookmarkMoveUp" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[inoremap <silent> { <cmd>lua require("packer.load")({'nvim-autopairs'}, { keys = "{" }, _G.packer_plugins)<cr>]]
vim.cmd [[noremap <silent> ] <cmd>lua require("packer.load")({'which-key.nvim'}, { keys = "]", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[noremap <silent> s <cmd>lua require("packer.load")({'which-key.nvim'}, { keys = "s", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-treesitter', 'indent-blankline.nvim', 'gitsigns.nvim', 'bufferline.nvim', 'mason.nvim', 'lualine.nvim', 'nvim-web-devicons'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'friendly-snippets'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'indent-blankline.nvim', 'gitsigns.nvim', 'bufferline.nvim', 'mason.nvim', 'lualine.nvim', 'nvim-web-devicons'}, { event = "BufRead *" }, _G.packer_plugins)]]
